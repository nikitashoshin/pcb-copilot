...
- `/result` - исходные требования проекта, инженерный анализ, результат генерации архитектуры, BoM, warnings и checkResults, а также экспорт BoM CSV, Markdown-отчета и ZIP-пакета проекта.
